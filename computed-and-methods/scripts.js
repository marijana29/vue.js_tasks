Vue.createApp({
  ...
  computed: {
    ...
    filteredBooks() {
      const filterPublisher = "O'Reilly Media";
      return this.books.filter((book) => book.publisher === filterPublisher);
    },
  },
  methods: {
    calculateDiscountedPrice(originalPrice) {
      ...
      const discount =
        (discountPercentage / 100) * parseFloat(originalPrice.replace("$", ""));
      const discountedPrice =
        parseFloat(originalPrice.replace("$", "")) - discount;
